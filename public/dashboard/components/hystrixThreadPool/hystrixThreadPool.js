...
(function(window) {
	...
	jQuery.get("/assets/dashboard/components/hystrixThreadPool/templates/hystrixThreadPool.html", function(data) {
		htmlTemplate = data;
	});
	jQuery.get("/assets/dashboard/components/hystrixThreadPool/templates/hystrixThreadPoolContainer.html", function(data) {
