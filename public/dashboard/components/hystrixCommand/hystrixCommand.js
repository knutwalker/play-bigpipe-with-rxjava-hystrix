...
(function(window) {
	...
	jQuery.get("/assets/dashboard/components/hystrixCommand/templates/hystrixCircuit.html", function(data) {
		hystrixTemplateCircuit = data;
	});
	jQuery.get("/assets/dashboard/components/hystrixCommand/templates/hystrixCircuitContainer.html", function(data) {
